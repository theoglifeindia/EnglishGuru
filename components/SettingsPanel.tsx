...
const SettingsPanel: React.FC<SettingsPanelProps> = ({ isOpen, onClose, onSave, initialProvider, initialKey }) => {
  ...
  }, [isOpen, initialProvider, initialKey]);
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <div className="p-6 space-y-6">
          <div>
            ...
            <p className="mt-2 text-xs text-slate-500 italic">Gemini is recommended for best pedagogical reasoning.</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-slate-500">
              Keys are stored in <strong>session storage</strong> and will be cleared when you close the tab.
            </p>
          </div>
